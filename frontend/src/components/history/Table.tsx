...
export default function StickyHeadTable() {
  ...
  const fetchRowData = async () => {
    ...
    const username = (decodeToken(cookie.userCred) as UserCred).username;
  ...
  const getFormattedDate = (date: string) => {
    ...
    let mm = (inp.getMonth() + 1); // Months start at 0!
    let dd = inp.getDate();
  ...
  return ( 
    ...
    { openView 
      ...
      :(<div className="flex flex-col justify-center items-center">
        <Typography variant='h3' align='center' marginBottom='15px'>{username}'s PeerPrep History</Typography>
